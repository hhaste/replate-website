...
import { Button, Card, CardBody, CardHeader, Checkbox, Select, SelectItem, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, useDisclosure, Calendar, Chip, Input } from '@nextui-org/react';

import NavBar from '../../comps/Nav';
import { useState } from 'react';

const businesses = [
  { id: 1, name: "Zingerman's Delicatessen", address: '422 Michigan Ave, Ann Arbor, MI', imageUrl: "https://www.zingermansdeli.com/app/uploads/2022/04/14_03_2_Zingermans_Reuben2-1024x683.jpg", food: "Corned Beef Sandwiches", description: 'Fresh organic meals.', pickupSpot: "BRUH Center", tags: ["Halal", "Vegan"] },
    ...
    <>
      <div className="flex flex-col min-h-screen bg-gray-50 px-6 py-5">
        ...
        <div className="container mx-auto">
          <h1 className="mt-16 text-2xl font-bold text-gray-800 mb-4">Nearby items</h1>
          <div className="flex space-x-4 items-center mb-6">
            <Select label="Select Packing Option" className='w-[30%] mr-10'>
              <SelectItem value="half-packed">Half-packed</SelectItem>
              <SelectItem value="fully-packed">Fully-packed</SelectItem>
              <SelectItem value="low-packaged">Low-packaged</SelectItem>
            </Select>
              ...
              <Card key={business.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <CardBody className="p-6 relative">
                  ...
                  <div className="absolute bottom-3 right-3">
                    <Button color="primary" auto shadow onClick={onOpen}>
                      View
                    </Button>
                  </div>
                </CardBody>
      ...
      <Modal isOpen={isOpen} onOpenChange={onOpenChange} size='2xl'>
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">{selected.address} | {selected.food}</ModalHeader>
              <ModalBody className="flex h-full">
                ...
                <div className="flex flex-col w-1/2 pl-4">
                  ...
                  <div className="flex flex-col">
                    <Calendar onChange={setSelectedDate} className="mt-2" />
                  </div>
                </div>
              </ModalBody>
