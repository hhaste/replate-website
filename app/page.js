  ...
  return (
    <div className="flex flex-col min-h-screen px-10 py-5 relative">
      ...
      <section className="flex-grow flex flex-col justify-center  relative">
        ...
        <p className="text-xl mt-10 opacity-90 max-w-[38%] leading-loose">We help connect local businesses with charity groups, providing a direct pipeline for surplus food exchange.</p>
